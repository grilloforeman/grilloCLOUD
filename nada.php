...
$dockerApiUrl = 'http://localhost:2375/v1.45/containers/json?all=true';

// Processar ações de Stop e Delete
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['stop_container_id'])) {
        $containerId = $_POST['stop_container_id'];
        $stopUrl = 'http://localhost:2375/v1.45/containers/' . $containerId . '/stop';
    ...
    if (isset($_POST['delete_container_id'])) {
        ...
        $deleteUrl = 'http://localhost:2375/v1.45/containers/' . $containerId . '?force=true';
